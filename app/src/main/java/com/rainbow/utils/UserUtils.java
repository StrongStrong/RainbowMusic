...
import com.rainbow.activitys.LoginActivity;
...
public class UserUtils {
    public static boolean validateLogin(Context context,String phone,String pass){
        ...
        boolean result = realmHelper.validateUser(phone, EncryptUtils.encryptMD5ToString(pass));
